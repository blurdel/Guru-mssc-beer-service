...
import com.blurdel.msscbeerservice.services.inventory.model.BeerInventoryDto;
...
public class BeerInventoryServiceRestTemplateImpl implements BeerInventoryService {
	...
	public Integer getOnhandInventory(UUID beerId) {
		...
		// The.exchange() below is used with the GET method and binds the {beerId} to the URL
